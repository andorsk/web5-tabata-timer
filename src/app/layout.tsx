...
const APP_NAME = "Web5 Tabata Timer";
const APP_DEFAULT_TITLE = "Web5 Tabata Timer";
  ...
  return (
    <html lang="en">
      <Head>
        ...
        <meta
          name="description"
          content="no ads. open source. personal use. no tracking. free. no paywall. own your workout data with a web5 based tabata timer."
        />
